package com.example.mainscreen.presentation.fragment
...
import com.example.core.adapter.HotSalesItemDecoration
...
import com.example.mainscreen.presentation.adapters.CategoriesRVAdapter
...
class MainScreenFragment :
    ...
    private var adapterHotSales: BaseAdapter<HomeStoreDto, BaseItemListener>? = null
    private var adapterBestSellerDto: BaseAdapter<BestSellerDto, BestSellerItemListener>? = null
    ...
    override fun provideSuccess(data: MainDto) {
        data.homeStoreDto?.let { adapterHotSales?.setData(it) }
        data.bestSellerDto?.let { adapterBestSellerDto?.setData(it) }
        showProducts()
    }
    ...
    private fun initEmptyLists() {
        with(viewBinding) {
            ...
            adapterBestSellerDto?.setData(listOf())
            hideProducts()
        }
    }
